...
Section "FTView服务端" FTViewServer
  ...
  File /r "${InstallFilesDir}\HMIClient.dll"
  File /r "${InstallFilesDir}\HMICompile.exe"
  File /r "${InstallFilesDir}\HMICompile.exe.config"
  File /r "${InstallFilesDir}\ICSharpCode.TextEditor.dll"
  File /r "${InstallFilesDir}\Interop.ACTIVEXFINDERLib.dll"
  File /r "${InstallFilesDir}\Interop.DCCECLIENTLib.dll"
...
Section "FTView客户端" FTViewClient
  ...
  File "${InstallFilesDir}\HMIRUN\HMIClient.dll"
