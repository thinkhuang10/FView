...
public class drawbitmap3 : CPixieControl
{
    ...
    {
        drawbitmap3 drawbitmap8 = (drawbitmap3)base.Copy();
    ...
    public void Paint(Graphics g)
    {
        ...
        PointF[] points = new PointF[16]
        {
            ...
            new(15 * _width / 120, 40 * _height / 150),
            new(20 * _width / 120, 43 * _height / 150),
            new(25 * _width / 120, 48 * _height / 150),
            new(28 * _width / 120, 55 * _height / 150),
            new(33 * _width / 120, 60 * _height / 150),
            new(40 * _width / 120, 70 * _height / 150),
            new(45 * _width / 120, 80 * _height / 150),
            new(42 * _width / 120, 88 * _height / 150),
            new(39 * _width / 120, 95 * _height / 150),
            new(35 * _width / 120, 100 * _height / 150),
            new(25 * _width / 120, 105 * _height / 150),
            new(15 * _width / 120, 115 * _height / 150),
        ...
        Size size = new(30 * _width / 120, 12 * _height / 150);
        Size size2 = new(20 * _width / 120, 12 * _height / 150);
        Size size3 = new(35 * _width / 120, 12 * _height / 150);
        Size size4 = new(15 * _width / 120, 12 * _height / 150);
        Size size5 = new(25 * _width / 120, 4 * _height / 150);
        Rectangle[] array = new Rectangle[24];
        Point location = new(25 * _width / 120, 30 * _height / 150);
        ref Rectangle reference = ref array[0];
        reference = new Rectangle(location, size);
        location = new Point(55 * _width / 120, 30 * _height / 150);
        ref Rectangle reference2 = ref array[1];
        reference2 = new Rectangle(location, size2);
        location = new Point(75 * _width / 120, 30 * _height / 150);
        ref Rectangle reference3 = ref array[2];
        reference3 = new Rectangle(location, size3);
        location = new Point(30 * _width / 120, 42 * _height / 150);
        ref Rectangle reference4 = ref array[3];
        reference4 = new Rectangle(location, size3);
        location = new Point(65 * _width / 120, 42 * _height / 150);
        ref Rectangle reference5 = ref array[4];
        reference5 = new Rectangle(location, size2);
        location = new Point(85 * _width / 120, 42 * _height / 150);
        ref Rectangle reference6 = ref array[5];
        reference6 = new Rectangle(location, size2);
        location = new Point(40 * _width / 120, 54 * _height / 150);
        ref Rectangle reference7 = ref array[6];
        reference7 = new Rectangle(location, size2);
        location = new Point(75 * _width / 120, 54 * _height / 150);
        ref Rectangle reference8 = ref array[7];
        reference8 = new Rectangle(location, size2);
        location = new Point(95 * _width / 120, 54 * _height / 150);
        ref Rectangle reference9 = ref array[8];
        reference9 = new Rectangle(location, size4);
        location = new Point(45 * _width / 120, 66 * _height / 150);
        ref Rectangle reference10 = ref array[9];
        reference10 = new Rectangle(location, size3);
        location = new Point(75 * _width / 120, 66 * _height / 150);
        ref Rectangle reference11 = ref array[10];
        reference11 = new Rectangle(location, size4);
        g.DrawRectangle(Pens.Black, 90 * _width / 120, 66 * _height / 150, 20 * _width / 120, 12 * _height / 150);
        location = new Point(55 * _width / 120, 78 * _height / 150);
        ref Rectangle reference12 = ref array[11];
        reference12 = new Rectangle(location, size2);
        location = new Point(75 * _width / 120, 78 * _height / 150);
        ref Rectangle reference13 = ref array[12];
        reference13 = new Rectangle(location, size);
        location = new Point(45 * _width / 120, 90 * _height / 150);
        ref Rectangle reference14 = ref array[13];
        reference14 = new Rectangle(location, size);
        location = new Point(75 * _width / 120, 90 * _height / 150);
        ref Rectangle reference15 = ref array[14];
        reference15 = new Rectangle(location, size4);
        location = new Point(90 * _width / 120, 90 * _height / 150);
        ref Rectangle reference16 = ref array[15];
        reference16 = new Rectangle(location, size2);
        location = new Point(40 * _width / 120, 102 * _height / 150);
        ref Rectangle reference17 = ref array[16];
        reference17 = new Rectangle(location, size2);
        location = new Point(60 * _width / 120, 102 * _height / 150);
        ref Rectangle reference18 = ref array[17];
        reference18 = new Rectangle(location, size);
        g.DrawRectangle(Pens.Black, 90 * _width / 120, 102 * _height / 150, 20 * _width / 120, 12 * _height / 150);
        location = new Point(35 * _width / 120, 114 * _height / 150);
        ref Rectangle reference19 = ref array[18];
        reference19 = new Rectangle(location, size4);
        location = new Point(50 * _width / 120, 114 * _height / 150);
        ref Rectangle reference20 = ref array[19];
        reference20 = new Rectangle(location, size);
        location = new Point(80 * _width / 120, 114 * _height / 150);
        ref Rectangle reference21 = ref array[20];
        reference21 = new Rectangle(location, size2);
        location = new Point(20 * _width / 120, 126 * _height / 150);
        ref Rectangle reference22 = ref array[21];
        reference22 = new Rectangle(location, size5);
        location = new Point(45 * _width / 120, 126 * _height / 150);
        ref Rectangle reference23 = ref array[22];
        reference23 = new Rectangle(location, size5);
        location = new Point(70 * _width / 120, 126 * _height / 150);
        ref Rectangle reference24 = ref array[23];
        reference24 = new Rectangle(location, size5);
        g.DrawRectangle(Pens.Black, 95 * _width / 120, 126 * _height / 150, 15 * _width / 120, 4 * _height / 150);
        g.DrawRectangles(Pens.Black, array);
        Rectangle rect = new(30 * _width / 120, 10 * _height / 150, 20 * _width / 120, 10 * _height / 150);
        Rectangle rect2 = new(70 * _width / 120, 10 * _height / 150, 20 * _width / 120, 10 * _height / 150);
        Rectangle rect3 = new(10 * _width / 120, 140 * _height / 150, 100 * _width / 120, 10 * _height / 150);
        g.FillRectangle(brush, rect);
        g.FillRectangle(brush, rect2);
        g.FillRectangle(brush, rect3);
        g.DrawLine(Pens.Black, 35 * _width / 120, 20 * _height / 150, 35 * _width / 120, 30 * _height / 150);
        g.DrawLine(Pens.Black, 40 * _width / 120, 20 * _height / 150, 40 * _width / 120, 30 * _height / 150);
        g.DrawLine(Pens.Black, 45 * _width / 120, 20 * _height / 150, 45 * _width / 120, 30 * _height / 150);
        g.DrawLine(Pens.Black, 75 * _width / 120, 20 * _height / 150, 75 * _width / 120, 30 * _height / 150);
        g.DrawLine(Pens.Black, 80 * _width / 120, 20 * _height / 150, 80 * _width / 120, 30 * _height / 150);
        g.DrawLine(Pens.Black, 85 * _width / 120, 20 * _height / 150, 85 * _width / 120, 30 * _height / 150);
        g.DrawLine(Pens.Black, 21 * _width / 120, 130 * _height / 150, 21 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 32 * _width / 120, 130 * _height / 150, 32 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 43 * _width / 120, 130 * _height / 150, 43 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 54 * _width / 120, 130 * _height / 150, 54 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 65 * _width / 120, 130 * _height / 150, 65 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 76 * _width / 120, 130 * _height / 150, 76 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 87 * _width / 120, 130 * _height / 150, 87 * _width / 120, 140 * _height / 150);
        g.DrawLine(Pens.Black, 99 * _width / 120, 130 * _height / 150, 99 * _width / 120, 140 * _height / 150);
    }
        ...
        try
        {
            ...
            try
            {
                ...
                if (Value >= low && Value <= high)
                {
                    highalertflag = false;
                    lowalertflag = false;
                    Rectangle rect = new(10 * _width / 120, (130 - 100 * lowpst / 100 - Convert.ToInt32((float)(100 * (highpst - lowpst) / 100) * (Value - low) / (high - low))) * _height / 150, 95 * _width / 120, Convert.ToInt32((float)(100 * (highpst - lowpst) / 100) * (Value - low) / (high - low)) * _height / 150);
                    Rectangle rect2 = new(10 * _width / 120, 30 * _height / 150, 95 * _width / 120, 100 * _height / 150);
                ...
                else if (Value > high)
                {
                    ...
                    Rectangle rect3 = new(10 * _width / 120, 30 * _height / 150, 95 * _width / 120, 100 * _height / 150);
                ...
                else if (Value < low)
                {
                    ...
                    Rectangle rect4 = new(10 * _width / 120, 30 * _height / 150, 95 * _width / 120, 100 * _height / 150);
                    graphics.FillRectangle(brush2, rect4);
                }
                Rectangle rect5 = new(9 * _width / 120, 30 * _height / 150, 95 * _width / 120, 100 * (100 - highpst) / 100 * _height / 150);
                Rectangle rect6 = new(10 * _width / 120, (130 - 100 * lowpst / 100) * _height / 150, 95 * _width / 120, 100 * lowpst / 100 * _height / 150);
                graphics.FillRectangle(brush2, rect5);
                graphics.FillRectangle(brush, rect6);
                Pen pen = new(colortype);
                graphics.DrawLine(pen, 11 * _width / 120, (130 - 100 * lowpst / 100) * _height / 150, 105 * _width / 120, (130 - 100 * lowpst / 100) * _height / 150);
                Paint(graphics);
            }
            catch
            {
    ...
    public override void Deserialize(byte[] data)
    {
        try
        {
            ...
            SaveC3 saveC = (SaveC3)formatter.Deserialize(stream);
            stream.Close();
