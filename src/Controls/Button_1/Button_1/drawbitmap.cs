...
public class drawbitmap : CPixieControl
{
    ...
    {
        drawbitmap drawbitmap32 = (drawbitmap)base.Copy();
    ...
    public void Paint(Graphics g)
    {
        ...
        PointF[] points = new PointF[3]
        {
            ...
            new Point(Convert.ToInt32((double)weith * 0.1), Convert.ToInt32((double)hight * 0.4)),
            new Point(Convert.ToInt32((double)weith * 0.9), Convert.ToInt32((double)hight * 0.4))
        };
        PointF[] points2 = new PointF[3]
        {
            new Point(Convert.ToInt32(weith / 2), Convert.ToInt32((double)hight * 0.9)),
            new Point(Convert.ToInt32((double)weith * 0.1), Convert.ToInt32((double)hight * 0.6)),
            new Point(Convert.ToInt32((double)weith * 0.9), Convert.ToInt32((double)hight * 0.6))
        };
        g.DrawPolygon(Pens.White, points);
        g.FillPolygon(brush, points);
        g.DrawPolygon(Pens.White, points2);
