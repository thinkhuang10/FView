...
[Guid("6C41966F-6C3C-44DD-A0F9-B2C0077FB6BA")]
[ClassInterface(ClassInterfaceType.AutoDispatch)]
[ComVisible(true)]
public class AirSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private SAVE_AirSwitch saveData = new();
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_AirSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("AirSwitch_ON");
    }
    ...
    private void AirSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("AirSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("AirSwitch_OFF");
    ...
    private void AirSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        AirSwitchSetForm airSwitchSetForm = new(saveData);
        airSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        airSwitchSetForm.ShowDialog();
    }
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "AirSwitchControl";
        this.Size = new System.Drawing.Size(133, 144);
        base.Load += new System.EventHandler(AirSwitchControl_Load);
        base.Click += new System.EventHandler(AirSwitchControl_Click);
