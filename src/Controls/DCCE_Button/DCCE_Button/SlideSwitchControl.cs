...
[Guid("534199B2-DD11-4B15-AA4E-F6B57E8F1E05")]
[ComVisible(true)]
public class SlideSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private bool isCheck;

    private SAVE_SlideSwitch saveData = new();
    ...
    {
        SAVE_SlideSwitch graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_SlideSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("SlideSwitch_ON");
    }
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("SlideSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("SlideSwitch_OFF");
    ...
    private void SlideSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        SlideSwitchSetForm slideSwitchSetForm = new(saveData);
        slideSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        slideSwitchSetForm.ShowDialog();
    }

    private void SlideSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "SlideSwitchControl";
        base.Load += new System.EventHandler(SlideSwitchControl_Load);
        base.Click += new System.EventHandler(SlideSwitchControl_Click);
