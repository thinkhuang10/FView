...
[Guid("691F8831-8495-42F0-9811-544FB78AD7CD")]
public class KnobSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private bool isCheck;

    private SAVE_KnobSwitch saveData = new();
    ...
    {
        SAVE_KnobSwitch graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_KnobSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("KnobSwitch_ON");
    }
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("KnobSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("KnobSwitch_OFF");
    ...
    private void KnobSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        KnobSwitchSetForm knobSwitchSetForm = new(saveData);
        knobSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        knobSwitchSetForm.ShowDialog();
    }

    private void KnobSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "KnobSwitchControl";
        base.Load += new System.EventHandler(KnobSwitchControl_Load);
        base.Click += new System.EventHandler(KnobSwitchControl_Click);
