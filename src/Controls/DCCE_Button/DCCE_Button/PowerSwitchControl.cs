...
[ComVisible(true)]
[Guid("D6AD35F0-C15F-46B6-886F-DAB15A2F542F")]
[ClassInterface(ClassInterfaceType.AutoDispatch)]
public class PowerSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private bool isCheck;

    private SAVE_PowerSwitch saveData = new();
    ...
    {
        SAVE_PowerSwitch graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_PowerSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("PowerSwitch_ON");
    }
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("PowerSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("PowerSwitch_OFF");
    ...
    private void PowerSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        PowerSwitchSetForm powerSwitchSetForm = new(saveData);
        powerSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        powerSwitchSetForm.ShowDialog();
    }

    private void PowerSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "PowerSwitchControl";
        base.Load += new System.EventHandler(PowerSwitchControl_Load);
        base.Click += new System.EventHandler(PowerSwitchControl_Click);
