...
[Guid("DB92CB3F-C559-473A-B51B-22A2F4B33663")]
[ComVisible(true)]
public class BigSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private bool isCheck;

    private SAVE_BigSwitch saveData = new();
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_BigSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("BigSwitch_ON");
    }
    ...
    private void BigSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("BigSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("BigSwitch_OFF");
    ...
    private void BigSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        BigSwitchSetForm bigSwitchSetForm = new(saveData);
        bigSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        bigSwitchSetForm.ShowDialog();
    }

    public BigSwitchControl()
    {
        InitializeComponent();
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "BigSwitchControl";
        base.Load += new System.EventHandler(BigSwitchControl_Load);
        base.Click += new System.EventHandler(BigSwitchControl_Click);
