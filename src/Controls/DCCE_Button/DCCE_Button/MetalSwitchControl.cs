...
public class MetalSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private bool isCheck;

    private SAVE_MetalSwitch saveData = new();
    ...
    {
        SAVE_MetalSwitch graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_MetalSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("MetalSwitch_ON");
    }
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("MetalSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("MetalSwitch_OFF");
    ...
    private void MetalSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        MetalSwitchSetForm metalSwitchSetForm = new(saveData);
        metalSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        metalSwitchSetForm.ShowDialog();
    }

    private void MetalSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "MetalSwitchControl";
        base.Load += new System.EventHandler(MetalSwitchControl_Load);
        base.Click += new System.EventHandler(MetalSwitchControl_Click);
