...
[Guid("63AF2FDC-57D4-40B9-BC9D-EA90FC5E5FCB")]
public class NormalSwitchControl : UserControl, IDCCEControl, IControlShape
{
    private bool isCheck;

    private SAVE_NormalSwitch saveData = new();
    ...
    {
        SAVE_NormalSwitch graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_NormalSwitch)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("NormalSwitch_ON");
    }
    ...
    private void NormalSwitchControl_Load(object sender, EventArgs e)
    {
    ...
    {
        ResourceManager resourceManager = new(typeof(ResourcePic));
        Bitmap bitmap = (Bitmap)resourceManager.GetObject("NormalSwitch_ON");
        Bitmap bitmap2 = (Bitmap)resourceManager.GetObject("NormalSwitch_OFF");
    ...
    private void NormalSwitchControl_Click(object sender, EventArgs e)
    {
        if (isRuning)
        {
            isCheck = !isCheck;
        ...
        NormalSwitchSetForm normalSwitchSetForm = new(saveData);
        normalSwitchSetForm.GetVarTableEvent += this.GetVarTableEvent;
        normalSwitchSetForm.ShowDialog();
    }

    public NormalSwitchControl()
    {
        InitializeComponent();
    ...
    private void InitializeComponent()
    {
        ...
        base.Name = "NormalSwitchControl";
        base.Load += new System.EventHandler(NormalSwitchControl_Load);
        base.Click += new System.EventHandler(NormalSwitchControl_Click);
