...
public class drawbitmap2 : CPixieControl
{
    ...
    {
        Rectangle rect = new(0, 0, 100 * _width / 100, 40 * _height / 100);
        new Rectangle(0, 0, 100 * _width / 100, 20 * _height / 100);
        new Rectangle(0, 20 * _height / 100, 100 * _width / 100, 20 * _height / 100);
        LinearGradientBrush brush = new(rect, setcolor, Color.White, 90f);
        LinearGradientBrush brush2 = new(rect, Color.White, setcolor, 90f);
        Point[] points = new Point[4]
        {
            new(80 * _width / 100, 20 * _height / 100),
            new(100 * _width / 100, 0),
            new(0, 0),
            new(0, 20 * _height / 100)
        };
        Point[] points2 = new Point[4]
        {
            new(80 * _width / 100, 20 * _height / 100),
            new(60 * _width / 100, 40 * _height / 100),
            new(0, 40 * _height / 100),
            new(0, 20 * _height / 100)
        };
        g.FillPolygon(brush, points);
        g.FillPolygon(brush2, points2);
        Rectangle rect2 = new(60 * _width / 100, 0, 40 * _width / 100, 100 * _height / 100);
        LinearGradientBrush brush3 = new(rect2, setcolor, Color.White, LinearGradientMode.Horizontal);
        LinearGradientBrush brush4 = new(rect2, Color.White, setcolor, LinearGradientMode.Horizontal);
        Point[] points3 = new Point[4]
        {
            new(80 * _width / 100, 20 * _height / 100),
            new(60 * _width / 100, 40 * _height / 100),
            new(60 * _width / 100, 100 * _height / 100),
            new(80 * _width / 100, 100 * _height / 100)
        };
