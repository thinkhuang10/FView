...
public class drawbitmap7 : CPixieControl
{
    ...
    {
        Rectangle rect = new(30 * _width / 100, 0, 40 * _width / 100, 100 * _height / 100);
        ...
        Point[] array = new Point[4]
        {
            new(30 * _width / 100, 0),
            new(50 * _width / 100, 0),
            new(50 * _width / 100, 50 * _height / 100),
            new(30 * _width / 100, 30 * _height / 100)
        };
        Point[] array2 = new Point[4]
        {
            new(50 * _width / 100, 50 * _height / 100),
            new(30 * _width / 100, 70 * _height / 100),
            new(30 * _width / 100, 100 * _height / 100),
            new(50 * _width / 100, 100 * _height / 100)
        };
        g.FillPolygon(brush, array);
        g.FillPolygon(brush, array2);
        ref Point reference = ref array[0];
        reference = new Point(50 * _width / 100, 50 * _height / 100);
        ref Point reference2 = ref array[1];
        reference2 = new Point(70 * _width / 100, 30 * _height / 100);
        ref Point reference3 = ref array[2];
        reference3 = new Point(70 * _width / 100, 0);
        ref Point reference4 = ref array[3];
        reference4 = new Point(50 * _width / 100, 0);
        ref Point reference5 = ref array2[0];
        reference5 = new Point(50 * _width / 100, 50 * _height / 100);
        ref Point reference6 = ref array2[1];
        reference6 = new Point(70 * _width / 100, 70 * _height / 100);
        ref Point reference7 = ref array2[2];
        reference7 = new Point(70 * _width / 100, 100 * _height / 100);
        ref Point reference8 = ref array2[3];
        reference8 = new Point(50 * _width / 100, 100 * _height / 100);
        g.FillPolygon(brush2, array);
        g.FillPolygon(brush2, array2);
        Rectangle rect2 = new(0, 30 * _height / 100, 100 * _width / 100, 40 * _height / 100);
        ...
        Rectangle rect3 = new(0, 30 * _height / 100, 30 * _width / 100, 20 * _height / 100);
        Rectangle rect4 = new(0, 50 * _height / 100, 30 * _width / 100, 20 * _height / 100);
        Rectangle rect5 = new(70 * _width / 100, 30 * _height / 100, 30 * _width / 100, 20 * _height / 100);
        Rectangle rect6 = new(70 * _width / 100, 50 * _height / 100, 30 * _width / 100, 20 * _height / 100);
        Rectangle rect7 = new(10 * _width / 100, 30 * _height / 100, 40 * _width / 100, 40 * _height / 100);
        Rectangle rect8 = new(50 * _width / 100, 30 * _height / 100, 40 * _width / 100, 40 * _height / 100);
        g.FillRectangle(brush3, rect3);
        g.FillRectangle(brush4, rect4);
        g.FillRectangle(brush3, rect5);
        g.FillRectangle(brush4, rect6);
        g.FillPie(brush3, rect7, 270f, 90f);
        g.FillPie(brush4, rect7, 0f, 90f);
        g.FillPie(brush3, rect8, 180f, 90f);
        g.FillPie(brush4, rect8, 90f, 90f);
    }
