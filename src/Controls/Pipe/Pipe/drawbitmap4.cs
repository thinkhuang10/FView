...
public class drawbitmap4 : CPixieControl
{
    ...
    public void Paint(Graphics g)
    {
        ...
        {
            new(20 * _width / 100, 20 * _height / 100),
            new(0, 0),
            new(100 * _width / 100, 0),
            new(100 * _width / 100, 20 * _height / 100)
        };
        Point[] points2 = new Point[4]
        {
            new(20 * _width / 100, 20 * _height / 100),
            new(40 * _width / 100, 40 * _height / 100),
            new(100 * _width / 100, 40 * _height / 100),
            new(100 * _width / 100, 20 * _height / 100)
        };
        g.FillPolygon(brush, points);
        g.FillPolygon(brush2, points2);
        Rectangle rect2 = new(0, 0, 40 * _width / 100, 100 * _height / 100);
