...
[Guid("54D3597F-B862-4EA8-BE7E-78D608295239")]
[ComVisible(true)]
[ClassInterface(ClassInterfaceType.AutoDispatch)]
public class CycleAlarmControl : UserControl, IDCCEControl, IControlShape
{
    private SAVE_CycleAlarm saveData = new();
    ...
    {
        SAVE_CycleAlarm graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_CycleAlarm)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("CycleAlarm_Red");
    }
    ...
    private void CycleAlarmControl_Load(object sender, EventArgs e)
    {
        if (!isRuning)
        {
            BackgroundImage = bmRed;
    ...
    private void CycleAlarmControl_Click(object sender, EventArgs e)
    {
        if (!isRuning)
        {
    ...
    public CycleAlarmControl()
    {
        ...
        ResourceManager resourceManager = new(typeof(ResourcePic));
        bmGreen = (Bitmap)resourceManager.GetObject("CycleAlarm_Green");
        bmBlack = (Bitmap)resourceManager.GetObject("CycleAlarm_Black");
        bmRed = (Bitmap)resourceManager.GetObject("CycleAlarm_Red");
    }
