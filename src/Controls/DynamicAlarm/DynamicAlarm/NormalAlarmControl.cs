...
[Guid("9092CFE6-DDEA-4C69-9D6E-879B84B2FF02")]
[ComVisible(true)]
[ClassInterface(ClassInterfaceType.AutoDispatch)]
public class NormalAlarmControl : UserControl, IDCCEControl, IControlShape
{
    ...
    private SAVE_NormalAlarm saveData = new();
    ...
    {
        SAVE_NormalAlarm graph = saveData;
    ...
    public void DeSerialize(byte[] bytes)
    {
        ...
        saveData = (SAVE_NormalAlarm)binaryFormatter.Deserialize(memoryStream);
        memoryStream.Dispose();
    }
    ...
    public static Image GetLogoStatic()
    {
        ...
        return (Bitmap)resourceManager.GetObject("NormalAlarm_Red");
    }
    ...
    private void NormalAlarmControl_Load(object sender, EventArgs e)
    {
        if (!isRuning)
        {
            BackgroundImage = bmRed;
    ...
    private void NormalAlarmControl_Click(object sender, EventArgs e)
    {
        if (!isRuning)
        {
    ...
    public NormalAlarmControl()
    {
        ...
        Cursor = Cursors.Hand;
        Size = new Size(132, 87);
        BackgroundImageLayout = ImageLayout.Stretch;
        ResourceManager resourceManager = new(typeof(ResourcePic));
        bmGreen = (Bitmap)resourceManager.GetObject("NormalAlarm_Green");
        bmBlack = (Bitmap)resourceManager.GetObject("NormalAlarm_Black");
        bmRed = (Bitmap)resourceManager.GetObject("NormalAlarm_Red");
    }
