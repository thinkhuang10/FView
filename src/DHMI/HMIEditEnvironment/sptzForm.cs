...
public class sptzForm : XtraForm
{
    ...
    public sptzForm(CGlobal _theglobal)
    {
        InitializeComponent();
    ...
    private void Form4_Load(object sender, EventArgs e)
    {
        try
        {
            textBox3.Text = theglobal.SelectedShapeList[0].sptzbianliang;
            textBox1.Text = theglobal.SelectedShapeList[0].sptzyidongmax.ToString();
            textBox2.Text = theglobal.SelectedShapeList[0].sptzyidongmin.ToString();
            textBox5.Text = theglobal.SelectedShapeList[0].sptzzhibianhuamin.ToString();
            textBox4.Text = theglobal.SelectedShapeList[0].sptzzhibianhuamax.ToString();
    ...
    IL_0084:
        ...
        try
        {
            ...
            theglobal.SelectedShapeList[0].sptzbianliang = textBox3.Text;
            theglobal.SelectedShapeList[0].sptzyidongmax = Convert.ToInt32(textBox1.Text);
            theglobal.SelectedShapeList[0].sptzyidongmin = Convert.ToInt32(textBox2.Text);
            theglobal.SelectedShapeList[0].sptzzhibianhuamin = Convert.ToInt32(textBox5.Text);
            theglobal.SelectedShapeList[0].sptzzhibianhuamax = Convert.ToInt32(textBox4.Text);
            if (!theglobal.SelectedShapeList[0].sptz && MessageBox.Show("是否激活相关配置?", "提示", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                theglobal.SelectedShapeList[0].sptz = true;
            }
            Close();
        }
        catch (Exception)
    ...
    private void InitializeComponent()
    {
        ...
        textBox2.TabIndex = 0;
        textBox2.Text = "0";
        textBox3.Location = new System.Drawing.Point(79, 18);
        ...
        groupControl2.Text = "向右像素变化";
        label8.AutoSize = true;
        label8.Location = new System.Drawing.Point(208, 36);
        label8.Name = "label8";
        ...
        label10.Location = new System.Drawing.Point(208, 37);
